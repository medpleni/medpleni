...
// ══════════════════════════════════════════════════════════
// SIMULADOS OFICIAIS & TEMÁTICOS (10 Simulados Reais)
// ══════════════════════════════════════════════════════════

export const mockSimulados: Simulado[] = [
  {
    id: "00000000-0000-0000-0000-000000000001",
    titulo: "ENAMED 2025 — Prova Oficial na Íntegra",
    instituicao: "ENAMED",
    area: "Clínica Médica",
    totalQuestoes: 90,
    duracaoMinutos: 240,
    status: "nao_iniciado",
    descricao: "Prova oficial definitiva aplicada pelo INEP. 90 questões reais comentadas com gabarito oficial pós-recursos.",
  },
  {
  ...
  },
  {
    ...
    titulo: "Revalida 2026/1 — Prova Oficial Definitiva",
  ...
  },
  {
    ...
    duracaoMinutos: 240,
    status: "nao_iniciado",
    descricao: "Última prova oficial com questões próprias do ENARE elaboradas pela FGV antes da unificação com o ENAMED.",
  },
  {
    id: "00000000-0000-0000-0000-000000000006",
    titulo: "ENARE 2021/2022 — Prova Oficial (Instituto AOCP)",
    instituicao: "ENARE",
    area: "Clínica Médica",
    totalQuestoes: 94,
    duracaoMinutos: 240,
    status: "nao_iniciado",
    descricao: "Prova de acesso direto oficial do ENARE com 94 questões validadas pós-recursos.",
  },
  {
    id: "00000000-0000-0000-0000-000000000007",
    titulo: "Simulado Temático: Atenção Primária & MFC",
    instituicao: "TEMÁTICO",
    area: "Medicina de Família e Comunidade",
    totalQuestoes: 50,
    duracaoMinutos: 75,
    status: "nao_iniciado",
    descricao: "Foco intensivo na área de maior peso emergente do ENAMED: abordagem centrada na pessoa, visitas e PNAB.",
  },
  {
    id: "00000000-0000-0000-0000-000000000008",
    titulo: "Simulado Temático: Saúde Materno-Infantil",
    instituicao: "TEMÁTICO",
    area: "Ginecologia e Obstetrícia",
    totalQuestoes: 60,
    duracaoMinutos: 90,
    status: "nao_iniciado",
    descricao: "Treinamento conjunto de GO e Pediatria cobrindo pré-natal, parto, puerpério, neonatologia e puericultura.",
  },
  {
    id: "00000000-0000-0000-0000-000000000009",
    titulo: "Simulado Temático: Clínica Médica & Urgências",
    instituicao: "TEMÁTICO",
    area: "Clínica Médica",
    totalQuestoes: 60,
    duracaoMinutos: 90,
    status: "nao_iniciado",
    descricao: "Manejo clínico em ambulatório e emergência: cardiologia, pneumologia, nefrologia e infectologia.",
  },
  {
    id: "00000000-0000-0000-0000-000000000010",
    titulo: "Simulado Temático: Cirurgia Geral & Trauma",
    instituicao: "TEMÁTICO",
    area: "Cirurgia Geral",
    totalQuestoes: 50,
    duracaoMinutos: 75,
    status: "nao_iniciado",
    descricao: "Abdome agudo, trauma (ATLS), pré/pós-operatório e patologias cirúrgicas essenciais.",
  },
];
